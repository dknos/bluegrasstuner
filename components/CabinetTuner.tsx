...
const SKIN: Record<Cabinet, {
  ...
  "festival": {
    tone: 'paper',
    pageBg: "linear-gradient(180deg, #e8b531 0%, #d99c1f 60%, #c08510 100%)",
    ink: '#2a1808', muted: 'rgba(42,24,8,0.55)', accent: "#9b3221",
    line: 'rgba(42,24,8,0.18)', panel: 'rgba(255,250,235,0.35)',
  },
  "pocket-watch": {
    tone: 'dark',
    pageBg: "radial-gradient(110% 70% at 50% 30%, #2a1c40 0%, #14102a 60%, #080615 100%)",
    ink: '#efe2c0', muted: 'rgba(239,226,192,0.55)', accent: "#7aa44a",
    line: 'rgba(239,226,192,0.16)', panel: 'rgba(0,0,0,0.22)',
  },
  "hymnal": {
    tone: 'paper',
    pageBg: "radial-gradient(120% 80% at 50% 30%, #f7ecd0 0%, #ebdbb0 60%, #d8c386 100%)",
    ink: '#2a1808', muted: 'rgba(42,24,8,0.55)', accent: "#7aa44a",
    line: 'rgba(42,24,8,0.18)', panel: 'rgba(255,250,235,0.35)',
  },
  "radio": {
    tone: 'dark',
    pageBg: "linear-gradient(180deg, #3a2414 0%, #28190d 60%, #1a0f06 100%)",
    ink: '#efe2c0', muted: 'rgba(239,226,192,0.55)', accent: "#9b3221",
    line: 'rgba(239,226,192,0.16)', panel: 'rgba(0,0,0,0.22)',
  },
  "split-flap": {
    tone: 'dark',
    pageBg: "linear-gradient(180deg, #20242a 0%, #14171b 60%, #0a0c0e 100%)",
    ink: '#efe2c0', muted: 'rgba(239,226,192,0.55)', accent: "#7aa44a",
    line: 'rgba(239,226,192,0.16)', panel: 'rgba(0,0,0,0.22)',
  },
  "banjo-head": {
    tone: 'dark',
    pageBg: "linear-gradient(180deg, #6b3d1c 0%, #4a2810 60%, #301a0a 100%)",
    ink: '#efe2c0', muted: 'rgba(239,226,192,0.55)', accent: "#b81e0e",
    line: 'rgba(239,226,192,0.16)', panel: 'rgba(0,0,0,0.22)',
  },
  "weathervane": {
    tone: 'paper',
    pageBg: "linear-gradient(180deg, #cdd6c0 0%, #aebb9e 45%, #8a9b7a 100%)",
    ink: '#2a1808', muted: 'rgba(42,24,8,0.55)', accent: "#b5764a",
    line: 'rgba(42,24,8,0.18)', panel: 'rgba(255,250,235,0.35)',
  },
  "apothecary": {
    tone: 'paper',
    pageBg: "linear-gradient(180deg, #f3e7c8 0%, #e6d2a4 60%, #d2b878 100%)",
    ink: '#2a1808', muted: 'rgba(42,24,8,0.55)', accent: "#b81e0e",
    line: 'rgba(42,24,8,0.18)', panel: 'rgba(255,250,235,0.35)',
  },
  "oscilloscope": {
    tone: 'dark',
    pageBg: "linear-gradient(180deg, #2e2a22 0%, #1c1914 60%, #0e0c08 100%)",
    ink: '#efe2c0', muted: 'rgba(239,226,192,0.55)', accent: "#7dff86",
    line: 'rgba(239,226,192,0.16)', panel: 'rgba(0,0,0,0.22)',
  },
  "spirit-level": {
    tone: 'dark',
    pageBg: "linear-gradient(180deg, #3a2414 0%, #281a0d 60%, #180f06 100%)",
    ink: '#efe2c0', muted: 'rgba(239,226,192,0.55)', accent: "#8fbf5a",
    line: 'rgba(239,226,192,0.16)', panel: 'rgba(0,0,0,0.22)',
  },
  "turntable": {
    tone: 'dark',
    pageBg: "linear-gradient(180deg, #4a3420 0%, #2a1d10 55%, #160e06 100%)",
    ink: '#efe2c0', muted: 'rgba(239,226,192,0.55)', accent: "#caa052",
    line: 'rgba(239,226,192,0.16)', panel: 'rgba(0,0,0,0.22)',
  },
  "pressure-gauge": {
    tone: 'dark',
    pageBg: "linear-gradient(180deg, #2a2a2e 0%, #1a1a1d 60%, #0d0d0f 100%)",
    ink: '#efe2c0', muted: 'rgba(239,226,192,0.55)', accent: "#b81e0e",
    line: 'rgba(239,226,192,0.16)', panel: 'rgba(0,0,0,0.22)',
  },
  "semaphore": {
    tone: 'dark',
    pageBg: "linear-gradient(180deg, #3a4a5a 0%, #2a3340 50%, #1a2028 100%)",
    ink: '#efe2c0', muted: 'rgba(239,226,192,0.55)', accent: "#7aff86",
    line: 'rgba(239,226,192,0.16)', panel: 'rgba(0,0,0,0.22)',
  },
  "mason-jar": {
    tone: 'paper',
    pageBg: "linear-gradient(180deg, #e8dcc0 0%, #d6c298 55%, #bfa770 100%)",
    ink: '#2a1808', muted: 'rgba(42,24,8,0.55)', accent: "#e8b531",
    line: 'rgba(42,24,8,0.18)', panel: 'rgba(255,250,235,0.35)',
  },
  "sundial": {
    tone: 'paper',
    pageBg: "linear-gradient(180deg, #f0c97a 0%, #d99c4a 45%, #b56a2a 100%)",
    ink: '#2a1808', muted: 'rgba(42,24,8,0.55)', accent: "#9b7a1e",
    line: 'rgba(42,24,8,0.18)', panel: 'rgba(255,250,235,0.35)',
  },
  "metronome": {
    tone: 'paper',
    pageBg: "linear-gradient(180deg, #f0e4c4 0%, #e2cf9e 60%, #ccb074 100%)",
    ink: '#2a1808', muted: 'rgba(42,24,8,0.55)', accent: "#9b3221",
    line: 'rgba(42,24,8,0.18)', panel: 'rgba(255,250,235,0.35)',
  },
  "balance": {
    tone: 'paper',
    pageBg: "linear-gradient(180deg, #ead9b4 0%, #d9c190 55%, #bfa068 100%)",
    ink: '#2a1808', muted: 'rgba(42,24,8,0.55)', accent: "#9b3221",
    line: 'rgba(42,24,8,0.18)', panel: 'rgba(255,250,235,0.35)',
  },
  "plumb-bob": {
    tone: 'paper',
    pageBg: "linear-gradient(180deg, #e6dcc4 0%, #d2c4a0 55%, #b3a078 100%)",
    ink: '#2a1808', muted: 'rgba(42,24,8,0.55)', accent: "#6b8a3a",
    line: 'rgba(42,24,8,0.18)', panel: 'rgba(255,250,235,0.35)',
  },
  "moon-dial": {
    tone: 'dark',
    pageBg: "radial-gradient(110% 70% at 50% 20%, #232047 0%, #14122e 55%, #0a0918 100%)",
    ink: '#efe2c0', muted: 'rgba(239,226,192,0.55)', accent: "#caa052",
    line: 'rgba(239,226,192,0.16)', panel: 'rgba(0,0,0,0.22)',
  },
  "high-striker": {
    tone: 'paper',
    pageBg: "linear-gradient(180deg, #f0dfb6 0%, #e8c878 55%, #d4a44a 100%)",
    ink: '#2a1808', muted: 'rgba(42,24,8,0.55)', accent: "#9b3221",
    line: 'rgba(42,24,8,0.18)', panel: 'rgba(255,250,235,0.35)',
  },
  "lantern": {
    tone: 'dark',
    pageBg: "radial-gradient(110% 75% at 50% 30%, #3a2a14 0%, #221708 55%, #110b04 100%)",
    ink: '#efe2c0', muted: 'rgba(239,226,192,0.55)', accent: "#f5b53a",
    line: 'rgba(239,226,192,0.16)', panel: 'rgba(0,0,0,0.22)',
  },
};
...
const CABINET_SWATCH: Record<Cabinet, [string, string]> = {
  ...
  "festival": ["#d99c1f", "#9b3221"],
  "pocket-watch": ["#14102a", "#caa052"],
  "hymnal": ["#ebdbb0", "#7aa44a"],
  "radio": ["#28190d", "#e8b863"],
  "split-flap": ["#15110c", "#caa052"],
  "banjo-head": ["#4a2810", "#b81e0e"],
  "weathervane": ["#aebb9e", "#b5764a"],
  "apothecary": ["#e6d2a4", "#b81e0e"],
  "oscilloscope": ["#0d2410", "#7dff86"],
  "spirit-level": ["#3a2414", "#8fbf5a"],
  "turntable": ["#2a1d10", "#caa052"],
  "pressure-gauge": ["#1a1a1d", "#b81e0e"],
  "semaphore": ["#2a3340", "#b81e0e"],
  "mason-jar": ["#d6c298", "#e8b531"],
  "sundial": ["#d99c4a", "#9b7a1e"],
  "metronome": ["#4a1d0e", "#caa052"],
  "balance": ["#d9c190", "#9b3221"],
  "plumb-bob": ["#d2c4a0", "#6b8a3a"],
  "moon-dial": ["#14122e", "#caa052"],
  "high-striker": ["#e8c878", "#9b3221"],
  "lantern": ["#221708", "#f5b53a"],
};
